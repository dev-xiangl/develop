...
public class WebSocketConnectHandler<S> implements ApplicationListener<SessionConnectEvent> {
	...
	private static final Logger logger = LogManager.getLogger(WebSocketConnectHandler.class);

	private SimpMessagingTemplate messagingTemplate;

	public WebSocketConnectHandler(final SimpMessagingTemplate messagingTemplate) {
		super();
	...
	public void onApplicationEvent(SessionConnectEvent event) {
		...
		this.messagingTemplate.convertAndSend(destination, user == null ? "" : Arrays.asList(user.getName()));
	}
}